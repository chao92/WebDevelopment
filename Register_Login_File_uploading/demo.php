...
<?php		if(!$USER->authenticated) { ?>
			...
			<form class="controlbox" name="new user registration" id="registration" action="demo.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="log in" id="login" action="demo.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="forgotten passwords" id="reset" action="demo.php" method="POST">
...
<?php 		}
			...
			<!-- Log out option -->
			<form class="controlbox" name="log out" id="logout" action="demo.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="update" id="update" action="demo.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="unregister" id="unregister" action="demo.php" method="POST">
