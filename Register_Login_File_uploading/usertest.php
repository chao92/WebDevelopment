<?php
	...
	class User
	{
		...
		function rebuild_database($dbfile)
		{
			...
			$create = "CREATE TABLE users (username TEXT UNIQUE, firstname Text, lastname Text, password TEXT, email TEXT UNIQUE, token TEXT, role TEXT, active TEXT, last TEXT, institution Text, country Text, fileversion INTEGER);";
